...
args = TrainingArguments(
    ...
    learning_rate=1e-4,
    max_steps=2000, #set maximum steps for training
    logging_dir="./logs",
    eval_strategy="steps",
    eval_steps=50,
    save_strategy="steps",
...
#fine tune
trainer.train(resume_from_checkpoint=r"output\checkpoint-1500")#set checkpoint

#save adapter
lora_model.save_pretrained(r"adapters\fantasy_adapter")#choose best name for the adapter
